...
### Element: AuditPool
Container element for feedback from the Service to the Consumer.

| Name | Consumer | Service | Description |
| --- | --- | --- | --- |
| AuditResource | r | w | Container element for resources generated by the Service  | 

#### Subelement: AuditResource
Container element for resources generated by the Service. 

| Name | Consumer | Service | Description |
| --- | --- | --- | --- |
| Header | r | w | Metadata about the service. |
